...
$totalSongs=1;
	...
	var playersRef = firebase.database().ref().child('songs/'+albumid+'/'+songId);
		playersRef.on("value", function(snapshot) {
		
			   songartist=snapshot.val().songArtist;
			   songlenth=snapshot.val().songLenght;
...
function getPath(){ 
     saveref = firebase.database().ref('songs/'+albumid);
...

{
  ...
  window.open("../albumsongslist.php", '_top');
...
<title>Hitstape-Upload Album Song</title>
                ...
                <div class="user">
					...
					<div>
                        <ul class="nav">
							...
							<li style="background-color: rgb(254,160,28);" ><a href="../videoslist.php"><span class="sidebar-normal">Albums</span></a></li>
