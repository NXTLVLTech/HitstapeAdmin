...
playersRef.on('child_added', function(data) {
	...
	$increment++;
	$userKey=data.key;  
	$("#table_body").append("<tr id ="+$userKey+">"+
								"<td ><b>"+$increment+"</b></td>"+
								"<td><b>"+data.val().songName+"</b></td>"+
								"<td><b>"+data.val().songArtist+"</b></td>"+
								"<td><b>"+data.val().songLenght+"</b></td>"+
								"<td ><b>"+data.val().songURL+"</b></td>"+
								"<td class='td-actions text-right'>"+
								"<button onclick='updateSong(this)' type='button' rel='tooltip' class='btn btn-simple btn-dangers btn-icon' style='color:#fea01c';>"+
 ...
 var id =row.id;
  ...
  document.cookie = "songId="+id ;
     document.cookie = "albumid="+albumid;
       window.open("../updateAlbumSongs.php", '_top');
}
function getRowId(element){
	...
	swal({title: 'Are you sure?',
			...
			var playersRef = firebase.database().ref("songs/"+albumid+"/");
...
<title>Hitstape-Album Songs</title>
				...
				<div class="user">
                    <div class="info">
                        ...
                        <div class="collapse" id="collapseExample">
                            <ul class="nav"><li><a  onClick=logout()><span class="sidebar-normal">Logout</span></a></li></ul>
                        </div>
                    </div>
					<div>
                        <ul class="nav">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Album Songs</h4>
