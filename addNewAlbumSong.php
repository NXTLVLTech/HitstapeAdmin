...
var playersRef = firebase.database().ref().child('songs/'+albumid+'/');
	<!-- var playersRef = firebase.database().ref().child("songs/"+albumid+");m-->
console.log('key  '+albumid);
...
function getPath(){ 
    var saveref = firebase.database().ref('songs/'+albumid);
	...
	if(title.length==0){
		...
		alert('Please select image for song'); 
  ...
  //const songfile = songfile.name;
		...
		task.then((snapshot) => {
					songtask.then((snapshotsong) => {
						var newID =saveref.push().key;
						console.log('snapshot url     '+snapshot.downloadURL);
						console.log('snapshotsong url     '+snapshotsong.downloadURL);
						console.log('newID     '+newID);
						var data={artwork:snapshot.downloadURL,
									numberOfPlays:0,
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            ...
                                                            <input name="artistname"  id ="artistname" type="text" class="form-control">
                                                        </div>
                                                    </div>													
													 <div class="input-group">
                                                        <span class="input-group-addon">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            ...
                                                            <input name="songlength"  id ="songlength" type="text" class="form-control">
                                                        </div>
														<div class="pull-right">                                           
															<input type="file"  id="wizard-song" accept="audio/*" class='btn btn-finish btn-fill btn-orange btn-wd' name='finish' value='Choose Song' />
														</div>
                                                    </div>
                                                </div>                                                
                                            </div>
