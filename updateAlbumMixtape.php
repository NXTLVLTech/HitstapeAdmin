...
firebase.initializeApp(config);
	...
	var playersRef = firebase.database().ref().child("discover/mixtape/"+albumid);
		playersRef.on("value", function(snapshot) {
		
		
			   albumArtist=snapshot.val().albumArtist;
			   albumName=snapshot.val().albumName;
			   artwork=snapshot.val().artwork;
			   numberOfPlays=snapshot.val().numberOfPlays;
		mixtapeID=snapshot.val().mixtapeID;
			...
			console.log('numberOfPlays  '+numberOfPlays);	
		    ...
		    document.getElementById("plays").setAttribute('value',numberOfPlays);
...
function getPath(){ 
    var saveref = firebase.database().ref('discover/mixtape');
	var ref = firebase.storage().ref().child('albumAndSong-pics');
	var namealbum=$('#name').val();
	var artist=$('#artist').val();
	numberOfPlays=$('#plays').val();
	//console.log('name  -- '+namealbum+'  artist  '+artist);
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            ...
                                                            <input name="name"   value= AlbumName id ="name" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            ...
                                                            <input name="artist" value= ArtistName id ="artist" type="text" class="form-control">
                                                        </div>
                                                    </div>
													<div class="input-group">
                                                        <span class="input-group-addon">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">No of Plays
                                                  
                                                            </label>
                                                            <input name="plays"  value= Plays id ="plays" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
