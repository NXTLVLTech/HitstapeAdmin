...
<script src="https://www.gstatic.com/firebasejs/4.3.1/firebase.js"></script>
	...
	var playersRef = firebase.database().ref().child('discover/mixtape/'+albumid+'/songs/');
   ...
   console.log('datakey  '+data.key);
    ...
    $("#table_body").append(
								 ...
								 "<tr id ="+$userKey+"><td ><b>"+
                                                     $increment+"</b></td><td><b>"+
                                                    data.val().songName+"</b></td><td><b>"+
                                                   data.val().songArtist+"</b></td><td><b>"+
												    data.val().length+"</b></td><td ><b>"+
												  data.val().songURL+"</b></td>"+'<td class="td-actions text-right">'+
...
function updateSong(element)
{
 ...
 var id =row.id;
  ...
  document.cookie = "songId="+id ;
     document.cookie = "albumid="+albumid;
       window.open("../updateAlbumMixTapeSongs.php", '_top');
}
 ...
 var id =row.id;
  ...
  cancelButtonText: 'No, keep it'
		...
		var playersRef = firebase.database().ref("discover/mixtape/"+albumid+"/songs/");
