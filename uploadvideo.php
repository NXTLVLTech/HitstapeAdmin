...
function	getPath()
  { 
    ...
    var saveref = firebase.database().ref('discover/musicvideos');
...
//const videofile = $('#wizard-video').get(0).files[0];
  ...
  {
	 alert('Please select image for video'); 
  }  
                                                    ...
                                                    <div class="input-group">
													 ...
													 <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            ...
                                                            <input name="youtubeurl"  id ="youtubeurl" type="text" class="form-control">
                                                        </div>
                                                    </div>
											<!--			    <div class="pull-right">
                                           
                                            <input type="file"  id="wizard-video" accept="video/*" class='btn btn-finish btn-fill btn-orange btn-wd' name='finish' value='Choose Song' />
                                        </div>
													-->
                                                </div>
