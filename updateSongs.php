...
<link rel="stylesheet" href="../adminpanel/assets/css/customstyle.css">
	...
	//var playersRef = firebase.database().ref().child("discover/newmusic").orderByChild('uid').equalTo(songId);
	var playersRef = firebase.database().ref().child("discover/newmusic/"+songId);
		playersRef.on("value", function(snapshot) {
		
		
		
		    // $userKey=snapshot.key;   
			 //console.log('key songURL '+snapshot.key.songURL);
			// console.log('val '+snapshot.val());
			 if(snapshot.key=='songURL')
			 {
				 		 console.log('songURL '+snapshot.val());
			 }
...
function	getPath()
  { 
    ...
    var saveref = firebase.database().ref('discover/newmusic');
...

{
  ...
  window.open("../songslist.php", '_top');
    ...
    <title>Hitstape-Upload New Music</title>
                            ...
                            <div class="card wizard-card" data-color="rose" id="wizardProfile">
                                <form action="" method="">
                                    ...
                                    <div style="background-color: rgb(254,160,28);">
                                        <ul>
                                            <li>
                                                <a href="#about" data-toggle="tab">New Music</a>
                                            </li>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane" id="about">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            <label id="labelsong" class="control-label">Song Name
                                                                <small>(required)</small>
                                                            </label>
                                                            <input name="title" value= songname   id ="title" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                            ...
                                            <input type="file" onchange="onSongChange()" id="wizard-song" accept="audio/*" class='btn btn-finish btn-fill btn-orange btn-wd' name='finish' value='Choose Song' />
                                        </div>
                                                    </div>
                                                </div>
