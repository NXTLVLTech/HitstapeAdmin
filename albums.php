...
<script src="https://www.gstatic.com/firebasejs/4.3.1/firebase.js"></script>
	...
	$increment=0;
	var playersRef = firebase.database().ref().child("discover/mixtape").orderByChild('timestamp');
...
console.log($albumID)	;							  
                                ...
                                $("#table_body").append(
								 ...
								 "<tr  id ="+$albumID+"><td ><b>"+
                                                     $increment+"</b></td><td><b>"+
                                                    snapshot.child("albumName").val()+"</b></td><td><b>"+
                                                   snapshot.child("albumArtist").val()+"</b></td><td><b>"+
												   snapshot.child("numberOfPlays").val()+"</b></td><td ><b>"+
												   snapshot.child("artwork").val()+"</b></td>"+
												   
												   '<td class="td-actions text-right">'+
												     
                                                        '<button     onclick="getRowId(this)" type="submit" class="button">Songs'+
                                                              '</button></td>'+
												   ...
												   '<td class="td-actions text-right">'+
                                                        ...
                                                        '<button onclick="getDeleteAlbum(this)" type="button" rel="tooltip" class="btn btn-simple btn-dangers btn-icon"  style="color:#fea01c";>'+
...
function submitCall(albumID){
 ...
 var id =row.id;
  ...
  window.open("../updateAlbumMixtape.php", '_top');
 }
 ...
 var id =row.id;
  ...
  cancelButtonText: 'No, keep it'
		...
		var playersRef = firebase.database().ref("discover/mixtape/");
		playersRef.child(id).remove();
 console.log('success delete'+result.value);
   window.open("../albums.php", '_top');
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
								...
								<a href="../uploadalbum.php">								<div _ngcontent-c1=""  class="card-header card-header-icon" data-background-color="orange" style="float: right;"><i _ngcontent-c1="" class="material-icons">add</i></div></a>
                                <div class="card-content">
                                    <h4 class="card-title">Mix Tape</h4>
