...
<script src="https://www.gstatic.com/firebasejs/4.3.1/firebase.js"></script>
	...
	$increment=0;
		var playersRef = firebase.database().ref().child('discover/news').orderByChild('timestamp');
 ...
 var id =row.id;
  ...
  document.cookie = "newsId="+id;

  window.open("../updateNews.php", '_top');
 }
 ...
 var id =row.id;
  ...
  cancelButtonText: 'No, keep it'
		...
		var playersRef = firebase.database().ref("discover/news");
