...
$increment=0;
function getPath(){ 
	var saveref = firebase.database().ref('albums');
	...
	if(namealbum.length==0){
		...
		alert('Please select image for album'); 
	}else{
		...
		task.then((snapshot) => {
					...
					console.log('keyyyyyyyyyyy     '+newID);
                                        ...
                                        <div class="tab-pane" id="about">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
													...
													<input type="radio" name="mixtapeType" value="classic" checked="true"> Classic<br>
													<input type="radio" name="mixtapeType" value="mostRecent" > Recent<br>
													<input type="radio" name="mixtapeType" value="topCharts"> Top Charts<br>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
