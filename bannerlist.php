...
<script src="https://www.gstatic.com/firebasejs/4.3.1/firebase.js"></script>
	...
	$increment=0;
		var playersRef = firebase.database().ref().child('discover/banner').orderByChild('timestamp');
   ...
   //data.key will be like -KPmraap79lz41FpWqLI
	 ...
	 $("#table_body").append(
                                                  ...
                                                  "<tr  id ="+$userKey+"><td>"+'<div class="img-container">'
                                                        +'<img src='+data.val().imageUrl+' alt="..."></div></td>'
 ...
 var id =row.id;
  ...
  window.open("../bannerlist.php", '_top');
 }
 ...
 var id =row.id;
  ...
  cancelButtonText: 'No, keep it'
		...
		var playersRef = firebase.database().ref("discover/banner");
