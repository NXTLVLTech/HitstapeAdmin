...
<script src="https://www.gstatic.com/firebasejs/4.3.1/firebase.js"></script>
	...
	$increment=0;
		var playersRef = firebase.database().ref().child('discover/musicvideos').orderByChild('timestamp');
   ...
   //data.key will be like -KPmraap79lz41FpWqLI
	 ...
	 $("#table_body").append(
                                                  ...
                                                  " <tr  id ="+$userKey+"><td>"+'<div class="img-container">'
                                                        +'<img src='+data.val().imageUrl+' alt="..."></div></td><td><b>'
                                                         +data.child("title").val()+"</b></td><td><b>"+
                                                   data.child("text").val()+"</b></td><td><b>"+
												   data.child("youtubeUrl").val()+"</b></td>"+
                                             ...
                                             '<button onclick="editVideo(this)" type="button" rel="tooltip" class="btn btn-simple btn-dangers btn-icon"  style="color:#fea01c";>'+
 ...
 var id =row.id;
  ...
  window.open("../updateVideo.php", '_top');
 }
...
function editVideo(element)
 ...
 var id =row.id;
  ...
  cancelButtonText: 'No, keep it'
		...
		var playersRef = firebase.database().ref("discover/musicvideos");
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-12">
                            <div class="card">
								...
								<a href="../uploadvideo.php">        <div ngcontent-c1=""  class="card-header card-header-icon" data-background-color="orange" style="float: right;"><i ngcontent-c1="" class="material-icons">add</i></div></a>
